    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative flex min-h-[88vh] flex-col overflow-hidden border-b border-primary/10 bg-gradient-to-b from-accent/60 via-background to-background">
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 py-16 text-center">
          <h1 className="mx-auto max-w-3xl text-4xl font-extrabold leading-[1.35] pb-1 text-foreground sm:text-5xl lg:text-6xl">
            <span className="block mb-3">{t("landing.heroTitle")}</span>
            <span className="block mb-3">{t("landing.heroTitle2")}</span>
      ...
      <footer className="border-t border-primary/10 bg-card">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex flex-col gap-3 border-t border-border pt-6">
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://www.facebook.com/profile.php?id=61590612145180"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook POSTA"
                className="flex size-9 items-center justify-center rounded-full border border-border bg-background text-muted-foreground cursor-pointer transition-colors duration-200 hover:border-primary hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              >
              ...
              <a
                href="https://www.tiktok.com/@posta.solution"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok POSTA"
                className="flex size-9 items-center justify-center rounded-full border border-border bg-background text-muted-foreground cursor-pointer transition-colors duration-200 hover:border-primary hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="size-4" aria-hidden="true">
